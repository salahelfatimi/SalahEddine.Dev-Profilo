                ...
                <div className="flex justify-center">
                    <div className=' relative'>
                        ...
                        <div className=' hidden lg:block  absolute -bottom-8 -right-8  '>
                            <Image  className="circle-animation  bottom-0 left-0"   src="/CerclaImage.png" width={150} height={150} alt="About" />
                            <div className=' absolute top-[3.3rem] right-[3.2rem]'>
                                <Image  className="  bottom-0 left-0"   src="/programming.png" width={50} height={50} alt="About" />
