            ...
            <div className="bg-[#ffffff] dark:bg-[#2d2e32] rounded-b-2xl  z-30  fixed top-0 right-0 left-0 shadow-2xl py-5 ">
                ...
                <div className=" flex justify-between items-center px-12">
                    ...
                    <div className="text-[#89797F] dark:text-white  flex gap-8 font-semibold ">
                        ...
                        <svg className={`${theme === "light"?"block":"hidden"}`} width="28px" height="28px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`fixed  inset-0 flex items-center justify-center bg-white dark:bg-[#2d2e32]  ${open==true?"block":"hidden"}`}>
                    ...
                    <div className=" text-black dark:text-[#fff] flex flex-col items-center gap-12 text-3xl font-bold">
                        ...
                        <button onClick={()=> setTheme(theme === "dark" ? "light" : "dark")} className=" ">
                            <svg className={` ${theme === "light"?"block":"hidden"}`} width="50px" height="50px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                    <g id="Layer_2" data-name="Layer 2">
                                    <g id="Icons">
                                    <g>
                                        <rect width="48" height="48" fill="none"/>
